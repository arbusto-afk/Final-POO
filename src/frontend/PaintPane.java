...
public class PaintPane extends BorderPane {
	...
	public PaintPane(CanvasState canvasState, StatusPane statusPane) {
        ...
        buttonsBox.getChildren().add(biseladoCheckbox);
        buttonsBox.getChildren().add(formatText);
        buttonsBox.getChildren().add(shadowTypeBox);
        ...
        shadowTypeBox.setOnAction(event -> {
		...
		//	figureColorMap.put(newFigure, gradient);
            newFigure.setBiselado(biseladoCheckbox.isSelected());
